...
# ax[1].plot(t, data['Largura de Pulso z'].sub(data['Largura de Pulso z'][0]-145), label='Sinal de Controle', color='0.75', ls='solid')
...
# ax[0].plot(t, data['Largura de Pulso z'].sub(data['Largura de Pulso z'][0]-145), label='Sinal de Controle', color='0.75', ls='solid')
...
# plt.rc('ytick', labelsize=18)
# plt.rc('axes', labelsize=18)
# plt.subplots_adjust(left=0.05, right=0.99, top=0.96, bottom=0.07)
